    ...
    <div className="relative isolate mt-10 lg:mt-0 w-screen ">
      ...
      >
        {informationdata.map((item) => (
          <motion.div key={item.label} whileHover={{ scale: 1.05 }} className="flex flex-col items-center text-center">
      ...
      <div className="w-full h-auto bg-white text-black py-20 px-30">
        ...
        <div className="grid grid-cols-1 sm:grid-col-2 md:grid-cols-3 gap-12 lg:gap-40 mt-10">
          {howItWorks.map((item) => (
            <motion.div key={item} whileHover={{ scale: 1.05 }} className="flex flex-col items-center gap-5">
