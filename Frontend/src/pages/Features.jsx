import "../App.css";
import { featureIcons } from "../utils/FeaturesData.js";
...
function Features() {
  ...
  // get translated data
  const featuresData = t("featureContent.features", { returnObjects: true });
  const technicalSpecifications = t(
    "featureContent.technicalSpecifications",
    { returnObjects: true }
  );
  ...
  return (
    <div className="pt-32 text-black w-screen bg-zinc-50">
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4 sm:px-12 md:px-16 lg:px-20 text-left">
